// Create a class called ShoppingCart with member variables for an array of products and their prices. Implement functions to add products to the cart, calculate the total price, and apply discounts. Instantiate a ShoppingCart object, add products, and calculate the final price.
...
int main()
{
    ...
    cout<<"Discount on Item: "<<totalCost*0.18<<endl;
    cout<<"----------------------------"<<endl;
